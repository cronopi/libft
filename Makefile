#variables  .PHONY: all fclean clean
LIB = ar rcs
RM = rm -f
...
src/ft_putendl_fd.c src/ft_itoa.c src/ft_lstadd_front.c src/ft_lstnew.c src/ft_lstsize.c src/ft_lstlast.c #src/ft_lstadd_back.c #src/ft_lstdelone\
src/ft_lstclear.c src/ft_lstiter src/ft_lstmap
